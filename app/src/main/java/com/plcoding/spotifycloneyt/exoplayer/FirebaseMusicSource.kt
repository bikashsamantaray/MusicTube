...
class FirebaseMusicSource @Inject constructor(
    ...
    suspend fun fetchedMediaData() = withContext(Dispatchers.IO){

        state = STATE_INITIALIZING
        val allSongs = musicDatabase.getAllSongs()
        songs = allSongs.map {song ->
            MediaMetadataCompat.Builder()
                .putString(METADATA_KEY_ARTIST, song.movie)
                ...
                .putString(METADATA_KEY_DISPLAY_SUBTITLE, song.movie)
                .putString(METADATA_KEY_DISPLAY_DESCRIPTION, song.movie)
                .build()
        }
